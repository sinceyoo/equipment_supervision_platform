...
public interface ArticleRepository extends JpaRepository<Article, String> {
	...
	@Query("from Article a where a.tag like %:vague% or a.title like %:vague% or a.summary like %:vague%")
	...
	@Query("from Article a where a.createTime>=:start and a.createTime<:end and (a.tag like %:vague% or a.title like %:vague% or a.summary like %:vague%)")
	...
	@Query("from Article a where a.author.account=:account and (a.tag like %:vague% or a.title like %:vague% or a.summary like %:vague%)")
	...
	@Query("from Article a where a.author.account=:account and a.createTime>=:start and a.createTime<:end and (a.tag like %:vague% or a.title like %:vague% or a.summary like %:vague%)")
